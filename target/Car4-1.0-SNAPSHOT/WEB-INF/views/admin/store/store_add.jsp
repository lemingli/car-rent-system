    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="store_name" placeholder="门店名称">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="store_address" placeholder="门店地址">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="store_phone" placeholder="联系电话">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select id="open_time" data-toggle="tooltip" data-placement="left" title="请选择营业时间"
                            class="custom-select">
            ...
            <div class="form-group row">
                <div class="col-md-11 offset-md-2">
                    <button class="btn btn-primary" value="提交" onclick="addStore()">提交</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function addStore() {
        ...
        if (store.store_name === null || store.store_name === '') {
            ...
            $.ajax({
                type: 'post',
                url: ctx + '/admin/store-add-handle',
